...
public interface StoreRepository  extends JpaRepository<Store, Integer> {
    ...
    public default List<Store> findByLocationId(Pagination pagination) {
        Page<Store> page = this.findByLocationId(pagination.getLi(),PageRequest.of(pagination.getPg() - 1, pagination.getSz(),
                                           Sort.Direction.ASC, "id"));
        pagination.setRecordCount((int)page.getTotalElements());
        return page.getContent();
    }
    ...
    public default List<Store> findByLocationIdAndMoodId(Pagination pagination) {
    	   Page<Store> page = this.findByLocationIdAndMoodId(pagination.getLi(),pagination.getMi(),
    ...
    public default List<Store> findByLocationIdAndPartyId(Pagination pagination) {
 	   Page<Store> page = this.findByLocationIdAndPartyId(pagination.getLi(),pagination.getPi(),
                PageRequest.of(pagination.getPg() - 1, pagination.getSz(), Sort.Direction.ASC, "id"));
        pagination.setRecordCount((int)page.getTotalElements());
        return page.getContent();
 }
    ...
    public default List<Store> findByLocationIdAndTagIdAndMoodId(Pagination pagination) {
 	   Page<Store> page = this.findByLocationIdAndTagIdAndMoodId(pagination.getLi(),pagination.getTi(),pagination.getMi(),
                PageRequest.of(pagination.getPg() - 1, pagination.getSz(), Sort.Direction.ASC, "id"));
        pagination.setRecordCount((int)page.getTotalElements());
        return page.getContent();
 }
    ...
    public default List<Store> findByLocationIdAndMoodIdAndPartyId(Pagination pagination) {
   	   Page<Store> page = this.findByLocationIdAndMoodIdAndPartyId(pagination.getLi(),pagination.getMi(),pagination.getPi(),
                  PageRequest.of(pagination.getPg() - 1, pagination.getSz(), Sort.Direction.ASC, "id"));
          pagination.setRecordCount((int)page.getTotalElements());
          return page.getContent();
   }
    ...
    public default List<Store> findByLocationIdAndTagIdAndMoodIdAndPartyId(Pagination pagination) {
    	   Page<Store> page = this.findByLocationIdAndTagIdAndMoodIdAndPartyId(pagination.getLi(),pagination.getTi(),pagination.getMi(),pagination.getPi(),
                   PageRequest.of(pagination.getPg() - 1, pagination.getSz(), Sort.Direction.ASC, "id"));
           pagination.setRecordCount((int)page.getTotalElements());
           return page.getContent();
    }
    ...
    public default List<Store> findByLocationIdAndTagId(Pagination pagination) {
        if (pagination.getLi() == 0 && pagination.getTi() == 0 && pagination.getMi() == 0 && pagination.getPi() == 0) return findAll(pagination);
        else if(pagination.getLi() != 0 && pagination.getTi() == 0 && pagination.getMi() == 0 && pagination.getPi() == 0) return findByLocationId(pagination);
        else if(pagination.getLi() == 0 && pagination.getTi() != 0 && pagination.getMi() == 0 && pagination.getPi() == 0) return findByTagId(pagination);
        else if(pagination.getLi() == 0 && pagination.getTi() == 0 && pagination.getMi() != 0 && pagination.getPi() == 0) return findByMoodId(pagination);
        else if(pagination.getLi() == 0 && pagination.getTi() == 0 && pagination.getMi() == 0 && pagination.getPi() != 0) return findByPartyId(pagination);
        else if(pagination.getLi() != 0 && pagination.getTi() == 0 && pagination.getMi() != 0 && pagination.getPi() == 0) return findByLocationIdAndMoodId(pagination);
        else if(pagination.getLi() != 0 && pagination.getTi() == 0 && pagination.getMi() == 0 && pagination.getPi() != 0) return findByLocationIdAndPartyId(pagination);
        else if(pagination.getLi() == 0 && pagination.getTi() != 0 && pagination.getMi() != 0 && pagination.getPi() == 0) return findByTagIdAndMoodId(pagination);
        else if(pagination.getLi() == 0 && pagination.getTi() != 0 && pagination.getMi() == 0 && pagination.getPi() != 0) return findByTagIdAndPartyId(pagination);
        else if(pagination.getLi() == 0 && pagination.getTi() == 0 && pagination.getMi() != 0 && pagination.getPi() != 0) return findByMoodIdAndPartyId(pagination);
        else if(pagination.getLi() != 0 && pagination.getTi() != 0 && pagination.getMi() != 0 && pagination.getPi() == 0) return findByLocationIdAndTagIdAndMoodId(pagination);
        else if(pagination.getLi() == 0 && pagination.getTi() != 0 && pagination.getMi() != 0 && pagination.getPi() != 0) return findByTagIdAndMoodIdAndPartyId(pagination);
        else if(pagination.getLi() != 0 && pagination.getTi() == 0 && pagination.getMi() != 0 && pagination.getPi() != 0) return findByLocationIdAndMoodIdAndPartyId(pagination);
        else if(pagination.getLi() != 0 && pagination.getTi() != 0 && pagination.getMi() != 0 && pagination.getPi() != 0) return findByLocationIdAndTagIdAndMoodIdAndPartyId(pagination);
        Page<Store> page = this.findByLocationIdAndTagId(pagination.getLi(),pagination.getTi(),
                PageRequest.of(pagination.getPg() - 1, pagination.getSz(), Sort.Direction.ASC, "id"));
        pagination.setRecordCount((int)page.getTotalElements());
        return page.getContent();
    }
